import { ArrayLiteral, BlockStatement, Boolean, CallExpression, ExpressionStatement, FunctionLiteral, HashLiteral, Identifier, IfExpression, IndexExpression, InfixExpression, IntegerLiteral, LetStatement, PrefixExpression, Program, ReturnStatement, StringLiteral } from "../ast/ast";
import { ArrayVal, BooleanVal, BuiltIn, ErrorVal, FunctionVal, HashPair, HashVal, IntegerVal, NullVal, ReturnVal, StringVal } from "../object/object";
